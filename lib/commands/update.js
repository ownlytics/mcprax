  ...
  program
    ...
    .action(async (options) => {
      ...
      if (options.enableNotifications) {
        ...
        console.log('\n' + chalk.green('Update notifications enabled.'));
        return;
      }
      
      if (options.disableNotifications) {
        setUpdateSettings({ checkEnabled: false });
        console.log('\n' + chalk.green('Update notifications disabled.'));
        return;
      }
      ...
      if (options.clearCache) {
        clearUpdateCache();
        console.log('\n' + chalk.blue('Update check cache cleared.'));
      }
      ...
      try {
        ...
        if (options.checkOnly) {
          console.log('\n' + chalk.cyan(`Run 'npm install -g ${require('../../package.json').name}' to update.`));
          return;
        }
        ...
        if (updateResult.success) {
          ...
          console.log('\n' + chalk.red('You may need to run the update command with administrator privileges.'));
