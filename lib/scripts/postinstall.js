...
function displayWelcomeMessage() {
  ...
  console.log();
  console.log(chalk.green('  rax --help') + chalk.magenta('                 # Show help information'));
  console.log(chalk.green('  rax create default') + chalk.magenta('          # Create a default rack'));
  console.log(chalk.green('  rax server create myapi node api.js') + chalk.magenta(' # Create a server configuration'));
  console.log(chalk.green('  rax mount myapi') + chalk.magenta('             # Add server to the active rack'));
  console.log(chalk.green('  rax apply') + chalk.magenta('                   # Apply configuration to Claude Desktop'));
  console.log();
